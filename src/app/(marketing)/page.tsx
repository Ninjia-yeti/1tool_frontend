...
const HomePage = () => {
  ...
  return (
    <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
      ...
      >
        ...
        <Container>
          <div className="flex items-center justify-center mx-auto mt-8">
            <Icons.feature className="w-auto h-100" />
          </div>
        </Container>
        <Container>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              Choose the best plan for your business and start your journey with{" "}
              <b>1Tool</b>
            </p>
          </div>
        </Container>
        <Container className="flex items-center justify-center mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 w-full md:gap-8 py-10 md:py-20 flex-wrap max-w-4xl">
            {pricingCards.map((card) => (
              <Card
                key={card.title}
                className={cn(
                  "flex flex-col w-full border-indigo-600",
              ...
              >
                ...
                <CardFooter className="mt-auto">
                  <Link
                    href="#"
                    className={cn(
                      "w-full text-center text-primary-foreground bg-indigo-600 p-2 rounded-md text-lg font-medium hover:bg-indigo-400"
      ...
      {/* testimonials */}
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        <div className="hidden md:block absolute -top-1/4 -left-1/3 w-72 h-72 bg-indigo-600 rounded-full blur-[10rem] -z-10"></div>
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              See how 1Tool empowers businesses of all sizes. Here&apos;s what
        ...
        <Container>
          <LampContainer>
            <div className="flex items-center justify-center w-full">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between w-full px-4 md:px-8 rounded-lg lg:rounded-2xl border border-border/80 border-indigo-600 py-4 md:py-8">
                <div className="flex flex-col items-start gap-4 w-full mx-5">
                ...
                <div className="flex flex-col items-start gap-2 md:min-w-80 mt-5 md:mt-0 w-full md:w-max">
                  ...
                  >
                    ...
                    <Button
                      ...
                      size="sm"
                      variant="secondary"
                      className="w-full md:w-max text-white"
                    >
                      Subscribe
                    </Button>
                  </form>
